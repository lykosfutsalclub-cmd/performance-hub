(() => {
  ...
  const serviceFrameworks = {
    hr:[
      ...
      ["Optimisation", "Ella applique directement les adaptations internes gratuites, réversibles et isolées ; seules les actions engageantes remontent à Fabien."],
    ],
  };
  const agentDisplayNames = {oscar:"Oscar",sophie:"Sophie",nadir:"Nadir",alice:"Alice",victor:"Victor",giannis:"Giannis",sonia:"Sonia",patricia:"Patricia",gaston:"Gaston",veronique:"Véronique",sandrine:"Sandrine",leonard:"Léonard",konstantinos:"Konstantinos",kostantinos:"Konstantinos",amara:"Amara",elena:"Elena",akira:"Akira",joyce:"Joyce",thiago:"Thiago",jefferson:"Jefferson",vincenzo:"Vincenzo",angela:"Angela",juan:"Juan",marco:"Marco",rafael:"Rafael",alba:"Alba",lola:"Lola",nora:"Nora",yanis:"Yanis",salome:"Salomé",malik:"Malik",ella:"Ella",ezio:"Ezio",bastien:"Bastien",salma:"Salma",mateo:"Mateo",priya:"Priya","sophie-rapprochement-sources":"Élise","nadir-indexation-video":"Samir","alice-controle-confidentialite":"Roman","victor-assiduite":"Camélia","giannis-qualite-donnees":"Francisco","veronique-tests-regression":"Tamara","sandrine-explicabilite-ux":"Inès","kostantinos-observation-publique":"Giorgios"};
  ...
  const esupportRoles = {
    ...
    Ella: {title:"Environnement & optimisation",summary:"Appliquer sans attente les optimisations internes sûres et réversibles.",purpose:"Ella maintient un environnement de travail fluide. Elle diagnostique, teste puis applique seule les adaptations gratuites, réversibles et isolées, sans attendre une validation préalable.",when:"Chaque semaine, dès qu’un besoin de capacité ou un blocage d’environnement est détecté, ou lorsqu’un outil, plugin, connecteur ou renfort temporaire évolue.",output:"Une optimisation appliquée ou un essai isolé avec mesure avant-après, preuve, limites et retour arrière."},
    Ezio: {title:"Responsable de l’intégration",summary:"Construire et contrôler le parcours d’arrivée de chaque nouvelle personne.",purpose:"Ezio transforme une création validée par Fabien en intégration complète : identité, personnalité professionnelle, mandat, circuit de travail, espace dédié, portrait, dépendances, contrôles et preuve visible.",when:"Après validation explicite du prénom et du rôle, puis à chaque évolution importante du parcours d’intégration.",output:"Un dossier d’intégration contrôlé, avec checklist, liens aux circuits existants, portrait, espace personnel, limites et décision d’activation."},
  };
  ...
  const operationalProfiles = {
    ...
    Ella:{inputs:"Besoin détecté, cadre actuel, catalogue de capacités, origine des outils, modèles, plugins et connecteurs, coût et moyen de retour arrière.",quality:"Exécuter directement ce qui est gratuit, réversible, isolé et sans donnée sensible ; mettre uniquement l’action douteuse en essai séparé et poursuivre le reste.",evidence:"Trace avant-après avec tests, droits utilisés, coût constaté et retour arrière. Fabien n’est sollicité que pour une dépense, un compte externe, un secret, une donnée personnelle, une publication, une permission persistante ou une action irréversible."},
    Ezio:{inputs:"Prénom et rôle validés par Fabien, service, hiérarchie, mission, sources, permissions, dépendances, cadence, contrôle qualité et actifs d’identité.",quality:"Nora contrôle le mandat, Salomé le circuit de travail, Ella l’espace et les outils, Amara les permissions, Konstantinos le portrait ; aucune activation si un contrôle manque.",evidence:"Dossier d’intégration signé par Ezio avec checklist complète, liens aux circuits, espace personnel, portrait, personnalité professionnelle et statut d’activation."},
