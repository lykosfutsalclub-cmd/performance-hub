(() => {
  ...
  const femaleAgents = new Set(["Sophie", "Véronique", "Patricia", "Alice", "Sandrine", "Sonia", "Amara", "Elena", "Joyce", "Élise", "Camélia", "Tamara", "Inès", "Angela", "Alba", "Lola", "Nora", "Salomé", "Ella", "Diane"]);
  ...
  const agentDisplayNames = {oscar:"Oscar",sophie:"Sophie",nadir:"Nadir",alice:"Alice",victor:"Victor",giannis:"Giannis",sonia:"Sonia",patricia:"Patricia",gaston:"Gaston",veronique:"Véronique",sandrine:"Sandrine",leonard:"Léonard",konstantinos:"Konstantinos",kostantinos:"Konstantinos",amara:"Amara",elena:"Elena",akira:"Akira",joyce:"Joyce",thiago:"Thiago",jefferson:"Jefferson",vincenzo:"Vincenzo",angela:"Angela",juan:"Juan",marco:"Marco",rafael:"Rafael",alba:"Alba",lola:"Lola",nora:"Nora",yanis:"Yanis",salome:"Salomé",malik:"Malik",ella:"Ella",diane:"Diane","sophie-rapprochement-sources":"Élise","nadir-indexation-video":"Samir","alice-controle-confidentialite":"Roman","victor-assiduite":"Camélia","giannis-qualite-donnees":"Francisco","veronique-tests-regression":"Tamara","sandrine-explicabilite-ux":"Inès","kostantinos-observation-publique":"Giorgios"};
  ...
  const esupportRoles = {
    ...
    Diane: {title:"Responsable conformité associative",summary:"Contrôler les obligations documentaires et leurs échéances.",purpose:"Diane tient le registre factuel des assurances, licences, contrats, avenants, documents obligatoires et règles de confidentialité ou de conservation. Elle alerte sur les pièces manquantes et les échéances sans rendre d’avis juridique.",when:"Lorsqu’un document obligatoire, un contrat, une licence, une règle de conservation ou une échéance est ajouté, modifié ou approche.",output:"Un registre documentaire sourcé avec statut, échéance, pièce manquante et décision humaine attendue, sans dépôt ni signature."},
  ...
  const operationalProfiles = {
    ...
    Diane:{inputs:"Assurances, licences, contrats, avenants, documents obligatoires, règles de confidentialité ou de conservation et échéances autorisées.",quality:"Relier chaque obligation à sa source, sa date, son responsable et son état ; signaler les limites et ne jamais transformer le contrôle en avis juridique.",evidence:"Registre documentaire daté avec pièces présentes, manquantes ou expirantes et validation humaine attendue."},
  ...
  function enforceReadOnlyMode() {
    ...
    for (const version of document.querySelectorAll("small")) {
      if (/^Rulebook \d+\.\d+\.\d+$/.test(version.textContent.trim())) version.textContent = "Rulebook 3.16.0";
    }
