  ...
  return {
    metadata: {
      ...
      formulas: {
        ...
        performanceRating: "soft competition weighting (friendly 1, competition 1.25, ProTour 1.5) -> global percentile -> FIFA-like calibrated rating where the median is 70 -> sample confidence over 8 matches",
