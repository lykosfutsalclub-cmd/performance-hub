...
export function renderMetronContent() {
  ...
  return `${START}
        ...
        <article class="lykos-metron-section">
          ...
          <p>Metron recalcule séparément la saison actuelle, la saison précédente, chaque année civile et l’historique All-time. Une statistique d’une période n’est jamais comparée à la population d’une autre période. Les années civiles sont reconstruites directement à partir des matchs compris entre le 1er janvier et le 31 décembre, et non par addition approximative de pages déjà affichées.</p>
