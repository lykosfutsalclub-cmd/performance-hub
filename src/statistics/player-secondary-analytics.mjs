  ...
  return {
    metadata: {
      ...
      formulas: {
        ...
        manOfTheMatchRating: "official total and rate per match remain visible recognition data; no additive overall-rating bonus",
        tenureRecognition: "known SportEasy seasons remain visible context; tenure does not alter the sporting average",
        positionWeighting: "Metron uses only the latest position recorded in SportEasy: goalkeeper 10/0/65 + 25 grade; defender 20/10/45 + 25 grade; midfielder or missing 35/20/20 + 25 grade; attacker 25/40/10 + 25 grade; no hybrid profile",
        overallRating: "FIFA-inspired role weighting: 75% creation + finishing + defensive ratings, plus 25% SportEasy average match rating when available; offensive excluded to prevent double counting; recognition does not alter the sporting average",
        overallWithoutPosition: "missing position uses midfielder weights: creation 35%, finishing 20%, defensive 20%, plus 25% grade; available from 10 matches in the selected period",
        ...
        awardRecognition: "official awards remain visible in honours and the Pantheon but do not alter the sporting average",
